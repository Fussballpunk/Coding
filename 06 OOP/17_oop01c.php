<?php
class behaeltnis {
	protected int $vol; //explizite Deklaration der Variable vol als private Integer-Variable
...
class behaeltnis_zauberhand extends behaeltnis {
	function __construct(int $volumen, string $farbe) {
		parent::__construct($volumen,$farbe);
	}
...
$flasche3 = new behaeltnis_zauberhand(750,"lila");

echo("<p>Die Farbe der ersten Flasche ist " . $flasche1->color_get() . ", die Farbe von Flasche 2 ist " . $flasche2->color_get() . ", die Farbe von Flasche 3 ist " . $flasche3->color_get() . "</p>");

$flasche2->color_set("türkis");
$flasche3->color_set("grün"); //das Objekt flasche3 möchte auf die Objekteigenschaft col zugreifen und diese verändern; die Eigenschaft col wurde in der Klasse behaeltnis deklariert
