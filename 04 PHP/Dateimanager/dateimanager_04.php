...
/* Veränderungen zur vorangegangenen Version:
   ...
   - Löschen von Verzeichnissen: beachte: das ROOTVZ darf nicht gelöscht werden und als Löschfunktion haben wir uns der Funktion loescheVZ aus der Funktionsbibliothek filedir.inc.php bedient
   - Umbenennen von Verzeichnissen (beachte: explode und implode)
   - Verschieben von Verzeichnissen (beachte: explode und implode sowie eine Funktion, die die Verzeichnisstruktur als Selectbox darstellt)
*/
