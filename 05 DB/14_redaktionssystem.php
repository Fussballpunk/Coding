		...
		<table>
			...
			while($user = $userliste->fetch_object()) {
				...
				echo('
					<tr>
						<td>' . $id . '</td>
						<td><input type="email" value="' . $user->Emailadresse . '" name="E_' . $id . '"></td>
						<td><input type="text" value="' . $user->Passwort . '" name="P_' . $id . '"></td>
						<td><input type="text" value="' . $user->Vorname . '" name="VN_' . $id . '"></td>
						<td><input type="text" value="' . $user->Nachname . '" name="NN_' . $id . '"></td>
						<td><input type="date" value="' . $user->GebDatum . '" name="GD_' . $id . '"></td>
						<td>' . $user->RegZeitpunkt . '</td>
						<td>
							<!--<input type="submit" value="' . $user->IDUser . '" name="btnLoeschen">-->
							<button type="submit" value="' . $user->IDUser . '" name="btnLoeschen">DEL</button>
							<button type="submit" value="' . $user->IDUser . '" name="btnAktualisieren">UPD</button>
						</td>
					</tr>
				');
			}
